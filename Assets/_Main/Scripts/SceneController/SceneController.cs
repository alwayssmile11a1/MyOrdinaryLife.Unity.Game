...
namespace Gamekit2D
{
    ...
    public class SceneController : MonoBehaviour
    {
        ...
        {
            Instance.StartCoroutine(Instance.Transition(Instance.m_CurrentZoneScene.name, Instance.m_ZoneRestartDestinationTag, newPos, TransitionPoint.TransitionType.DifferentZone));
        }

        public static void RestartZone(bool resetHealth = true)
        {

            Instance.StartCoroutine(Instance.Transition(Instance.m_CurrentZoneScene.name, Instance.m_ZoneRestartDestinationTag,null, TransitionPoint.TransitionType.DifferentZone));
        }
        ...
        {
            Instance.StartCoroutine(Instance.Transition(transitionPoint.newSceneName, transitionPoint.transitionDestinationTag,null, transitionPoint.transitionType));
        }
        ...
        protected IEnumerator Transition(string newSceneName, SceneTransitionDestination.DestinationTag destinationTag, Vector3? newPos = null, TransitionPoint.TransitionType transitionType = TransitionPoint.TransitionType.DifferentZone)
        {
